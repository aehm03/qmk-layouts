...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    ...
    _______,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_CAPS,   KC_DQUO,            KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_PSCR,  RSFT_T(KC_SPC),
  ...
  [_RAISE] = LAYOUT_reviung41(
    ...
    _______,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_CAPS,   KC_QUOT,            KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
  ...
  [_ADJUST] = LAYOUT_reviung41(
    ...
    XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,            QK_BOOT,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  TG_COL,
